export const imagePrompts = {
  hero: {
    ...
    replacementNote:
      'Replace with final facade photography of the real warehouse object when materials are approved.',
  },
  interior: {
    id: 'interior',
    ...
    replacementNote:
      'Replace with final interior photography of the real storage area.',
  },
  floorPlan: {
    id: 'floor-plan',
    ...
    replacementNote:
      'Replace with the measured floor plan or approved technical scheme of the real object.',
  },
  location: {
    id: 'location',
    ...
    replacementNote:
      'Replace with a real photo of the approach road or branded location visual when available.',
  },
};